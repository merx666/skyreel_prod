...
<div class="min-h-screen bg-gray-900 py-8">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="liquid-glass rounded-2xl p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-white mb-2">{{ __('Create Your Profile') }}</h1>
                <p class="text-gray-300">{{ __('Complete your profile to get started on SkyReel') }}</p>
            </div>
            ...
            <form action="{{ route('profiles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-6">
                        <div id="profile-preview" class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center">
                ...
                <div>
                    ...
                    <textarea id="bio" 
                              ...
                              class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none">{{ old('bio') }}</textarea>
                    @error('bio')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
